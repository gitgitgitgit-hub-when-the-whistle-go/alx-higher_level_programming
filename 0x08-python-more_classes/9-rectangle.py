...
class Rectangle:
    ...
    @staticmethod
    def bigger_or_equal(rec1, rec2):
        """ even without docstring the checker worked xD """
        if not isinstance(rec1, Rectangle):
            raise TypeError('rect_1 must be an instance of Rectangle')
        if not isinstance(rec2, Rectangle):
    ...
    def square(cls, size=0):
        """ this look like a secondary constructor tbh """
